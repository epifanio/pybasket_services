...
#     "lock", "long-arrow-down", "long-arrow-left", "long-arrow-right", "long-arrow-up", "low-vision" ,"magic", "magnet", "mail-forward",
#     "mail-reply", "mail-reply-all", "male", "maxcdn", "meanpath", "medkit", "meh-o", "microphone",
#     "map", "map-marker", "map-o", "map-pin", "map-signs" ,"microphone-slash", "minus", "minus-circle", "minus-square", "minus-square-o", "mobile", "mobile-phone", "money",
